...
*Documentos de salida esperados:* Archivos `.sql` o schemas de Drizzle/Prisma en texto plano para revisión.
...
*Consideraciones:* Tailwind CSS, estado global con Zustand, validaciones de formularios en frontend.
...
- 👨‍💻 **Ingeniero Next.js Senior:** Implementa usando Server Components donde sea posible por rendimiento, dejando los Client Components solo para interactividad (Zustand, Formularios, Selectores de Sede).
